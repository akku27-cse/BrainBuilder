  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>CSS Practice Problems</Text>
        <View style={{ width: 40 }} />
      </View>
...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#1572B6', padding: 16 },
  ...
  problemTitle: { fontSize: 18, fontWeight: 'bold', color: '#1572B6' },
  ...
  arrowIcon: { color: '#1572B6', position: 'absolute', right: 10, top: 18 },
});

export default CSSPracticeListScreen;
