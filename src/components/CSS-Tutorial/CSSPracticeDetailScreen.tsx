...
const CSSPracticeDetailScreen = () => { /* ...implementation... */ };

const styles = StyleSheet.create({
  mainContainer: { flex: 1, backgroundColor: '#fff' },
  container: { flex: 1, padding: 16 },
  header: { backgroundColor: '#1572B6', padding: 16 },
  headerContent: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  homeButton: { padding: 5 },
  headerTitle: { color: '#fff', fontSize: 20, fontWeight: 'bold' },
  headerRightSpacer: { width: 24 },
  problemHeader: { marginBottom: 16 },
  title: { fontSize: 22, fontWeight: 'bold', color: '#1572B6' },
  ...
  copyButton: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#1572B6', padding: 8, borderRadius: 6, alignSelf: 'flex-start', marginBottom: 10 },
  copyButtonText: { color: '#fff', marginLeft: 6, fontWeight: 'bold' },
  explanation: { fontSize: 15, color: '#333' },
});

export default CSSPracticeDetailScreen;
