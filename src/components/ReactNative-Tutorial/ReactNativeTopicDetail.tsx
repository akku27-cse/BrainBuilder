...
import reactNativeTutorialData from './reactNativeTutorialData.json';

const ReactNativeTopicDetail = ({ route, navigation }: any) => {
  const { topic } = route.params;
  const topicData = reactNativeTutorialData[topic as keyof typeof reactNativeTutorialData];
...
export default ReactNativeTopicDetail;
