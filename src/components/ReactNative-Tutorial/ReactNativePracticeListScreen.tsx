...
const ReactNativePracticeListScreen = () => {
  ...
  const navigateToDetail = (problemId: number) => {
    navigation.navigate('ReactNativePracticeDetail', { problemId });
  };
...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#61DAFB', padding: 16 },
  ...
  problemTitle: { fontSize: 18, fontWeight: 'bold', color: '#61DAFB' },
  ...
  arrowIcon: { color: '#61DAFB', position: 'absolute', right: 10, top: 18 },
});

export default ReactNativePracticeListScreen;
