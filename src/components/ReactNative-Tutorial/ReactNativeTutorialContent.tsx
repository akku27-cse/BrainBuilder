...
const ReactNativeTutorialContent = ({ navigation }: any) => {
  const topics = [
    {
      category: 'Basics',
      items: [
        { title: 'Introduction', icon: 'information' },
        { title: 'Environment Setup', icon: 'tools' },
        { title: 'Hello World', icon: 'console' },
        { title: 'Components', icon: 'cube-outline' },
        { title: 'Props', icon: 'package-variant' },
        { title: 'State', icon: 'database' },
        { title: 'Styling', icon: 'palette' },
      ]
    },
    {
      category: 'Navigation',
      items: [
        { title: 'React Navigation', icon: 'navigation' },
        { title: 'Stack Navigator', icon: 'layers' },
        { title: 'Tab Navigator', icon: 'tab' },
      ]
    },
    {
      category: 'APIs',
      items: [
        { title: 'Fetching Data', icon: 'cloud-download' },
        { title: 'AsyncStorage', icon: 'database' },
        { title: 'Networking', icon: 'access-point-network' },
      ]
    },
    {
      category: 'Advanced',
      items: [
        ...
        { title: 'Performance', icon: 'speedometer' },
      ]
    },
    {
      category: 'References',
  ...
  const handleTopicPress = (topic: string) => {
    navigation.navigate('ReactNativeTopicDetail', { topic });
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>React Native Tutorial</Text>
...
export default ReactNativeTutorialContent;
