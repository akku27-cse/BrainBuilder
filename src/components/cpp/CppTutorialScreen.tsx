...
const CppTutorialScreen = ({ navigation }: any) => {
  const cards = [
    { 
      title: 'Tutorial', 
      ...
      color: '#00599C',
      screen: 'CppTutorialContent'
    },
    { 
      title: 'Practice Programs', 
      description: 'Practice C++ coding problems with solutions', 
      icon: 'code-tags', 
      color: '#2ecc71',
      screen: 'CppPractice'
    },
    { 
      ...
      description: 'Common C++ interview questions and answers', 
      icon: 'comment-question-outline', 
      color: '#e74c3c',
      screen: 'CppInterview'
    },
    { 
      title: 'STL & OOP Concepts', 
      description: 'Standard Template Library and Object-Oriented Programming', 
      icon: 'cube-outline', 
      color: '#9b59b6',
      screen: 'CppStlOop'
    }
...
const styles = StyleSheet.create({
  ...
  header: {
    padding: 20,
    backgroundColor: '#00599C', // C++ brand color
    flexDirection: 'row',
...
export default CppTutorialScreen;