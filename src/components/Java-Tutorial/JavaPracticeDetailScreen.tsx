...
const JavaPracticeDetailScreen = () => { /* ...implementation... */ };
...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#007396', padding: 16 },
  ...
  copyButton: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#007396', padding: 8, borderRadius: 6, alignSelf: 'flex-start', marginBottom: 10 },
  copyButtonText: { color: '#fff', marginLeft: 6, fontWeight: 'bold' },
  explanation: { fontSize: 15, color: '#333' },
});

export default JavaPracticeDetailScreen;
