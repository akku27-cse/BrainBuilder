...
const JavaTutorialScreen = ({ navigation }: any) => {
  const cards = [
    { 
      title: 'Tutorial', 
      ...
      color: '#007396',
      screen: 'JavaTutorialContent'
    },
    { 
      title: 'Practice Programs', 
      description: 'Practice Java coding problems', 
      icon: 'code-tags', 
      color: '#2ecc71',
      screen: 'JavaPractice'
    },
    { 
      ...
      description: 'Java interview Q&A', 
      icon: 'comment-question-outline', 
      color: '#e74c3c',
      screen: 'JavaInterview'
    }
  ];
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <View style={styles.headerTextContainer}>
          <Text style={styles.headerTitle}>Java Tutorial</Text>
        </View>
...
export default JavaTutorialScreen;
