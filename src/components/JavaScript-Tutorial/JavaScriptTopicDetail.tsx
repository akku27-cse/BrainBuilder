const JavaScriptTopicDetail = ({ route, navigation }: any) => {
  const { topic } = route.params;
  const topicData = javascriptTutorialData[topic as keyof typeof javascriptTutorialData];
...
export default JavaScriptTopicDetail;
