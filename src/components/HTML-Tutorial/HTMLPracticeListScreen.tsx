  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>HTML Practice Problems</Text>
        <View style={{ width: 40 }} />
      </View>
...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#E34F26', padding: 16 },
  ...
  problemTitle: { fontSize: 18, fontWeight: 'bold', color: '#E34F26' },
  ...
  arrowIcon: { color: '#E34F26', position: 'absolute', right: 10, top: 18 },
});

export default HTMLPracticeListScreen;
