...
const HTMLTutorialScreen = ({ navigation }: any) => {
  const cards = [
    { 
      title: 'Tutorial', 
      ...
      color: '#E34F26',
      screen: 'HTMLTutorialContent'
    },
    { 
      title: 'Practice Programs', 
      description: 'Practice HTML coding problems', 
      icon: 'code-tags', 
      color: '#2ecc71',
      screen: 'HTMLPractice'
    },
    { 
      ...
      description: 'HTML interview Q&A', 
      icon: 'comment-question-outline', 
      color: '#e74c3c',
      screen: 'HTMLInterview'
    }
  ];
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <View style={styles.headerTextContainer}>
          <Text style={styles.headerTitle}>HTML Tutorial</Text>
        </View>
...
export default HTMLTutorialScreen;
