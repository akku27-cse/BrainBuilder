...
const ReactJSTutorialScreen = ({ navigation }: any) => {
  const cards = [
    { 
      title: 'Tutorial', 
      ...
      color: '#61DAFB',
      screen: 'ReactJSTutorialContent'
    },
    { 
      title: 'Practice Programs', 
      description: 'Practice React JS coding problems', 
      icon: 'code-tags', 
      color: '#2ecc71',
      screen: 'ReactJSPractice'
    },
    { 
      title: 'Interview Questions', 
      description: 'React JS interview Q&A', 
      icon: 'comment-question-outline', 
      color: '#e74c3c',
      screen: 'ReactJSInterview'
    }
  ];
...
export default ReactJSTutorialScreen;
