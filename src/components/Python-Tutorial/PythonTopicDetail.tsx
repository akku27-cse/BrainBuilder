const PythonTopicDetail = ({ route, navigation }: any) => {
  const { topic } = route.params;
  const topicData = pythonTutorialData[topic as keyof typeof pythonTutorialData];
...
export default PythonTopicDetail;
