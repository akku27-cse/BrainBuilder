...
const PythonPracticeDetailScreen = () => { /* ...implementation... */ };
...
const styles = StyleSheet.create({
  ...
  copyButton: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#3776AB', padding: 8, borderRadius: 6, alignSelf: 'flex-start', marginBottom: 10 },
  copyButtonText: { color: '#fff', marginLeft: 6, fontWeight: 'bold' },
  explanation: { fontSize: 15, color: '#333' },
});

export default PythonPracticeDetailScreen;
