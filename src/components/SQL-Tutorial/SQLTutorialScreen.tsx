...
const SQLTutorialScreen = ({ navigation }: any) => {
  const cards = [
    { 
      title: 'Tutorial', 
      ...
      color: '#4479A1',
      screen: 'SQLTutorialContent'
    },
    { 
      title: 'Practice Programs', 
      description: 'Practice SQL queries and problems', 
      icon: 'code-tags', 
      color: '#2ecc71',
      screen: 'SQLPractice'
    },
...
export default SQLTutorialScreen;
